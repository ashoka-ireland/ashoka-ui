...
export const WEBSITE_2 = 'website2';
export const TWITTER_HANDLE = 'twitterHandle';
export const FACEBOOK_PROFILE = 'facebookProfile';
...
export const ORGANISATION_SECTOR = 'organisationSector';
export const USER_SECTOR = 'userSector';
export const DUTIES = 'duties';
export const REASON_FOR_FIELD_OF_WORK = 'reasonForFieldOfWork';
